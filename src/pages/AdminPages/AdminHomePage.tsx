...
/>
        <AdminFeatureCard title="Users" image="/user.jpg" link="/doctor-user" description= "View and manage user accounts: access patient profiles, update user information, and ensure a smooth user experience across the platform."/>
        <AdminFeatureCard title="Appointments" image="/book.avif" link="/doctor-appointments" description="Access and manage all appointments between doctors and users. View upcoming visits"/>
        </div>
      </div>
    </>
  );
